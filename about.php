                            ...
                            <div class="col-sm-6 ab-grid">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">Own Shops</h5>
                                        <p class="card-text">A destiny for profit at your own store, pay once and profit forever</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 ab-grid">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">Rent Shops</h5>
                                        <p class="card-text">A payable store to make a business, a lifetime profit, when you pay monthly for the store</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 ab-grid mt-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">Lease Shops</h5>
                                        <p class="card-text">A store can be yours for an period of time for an commercial purpose</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 ab-grid mt-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">We have well known apartments all over the location</p>
                                    </div>
                                </div>
                            </div>
                        </div>
