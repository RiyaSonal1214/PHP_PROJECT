                                            ...
                                            <div class="sub-w3l">
                                                <div class="sub-agile">
                                                    <label for="brand1" style="text-align: center;">
                                                        <a href="changeuserpwd.php" style="color: white; text-align: center;">Change User Password</a></label>
                                                    <div class="clear"></div>
                                                </div>
                                            </div>
                                            </div>
...
<?php 
    if(isset($_POST['change']))
    {
        ...
        $qry=mysqli_query($con,"SELECT * FROM admin WHERE pwd='$opass' and username='$u_name'");
        $rows=mysqli_num_rows($qry);
            if($rows==1)
            {
                if($npass==$cpass)
                {
                    $sql=mysqli_query($con,"UPDATE admin SET pwd='$npass' WHERE username='$u_name'");
                    if($sql)
                    {
                    ...
                    {
                       echo '<script>alert("Failed"); window.location="change_pwd.php"; </script>'; 
                    }
                }
                else
                {
